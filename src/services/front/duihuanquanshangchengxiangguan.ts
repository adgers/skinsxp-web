...
/** 商城商品兑换 在个人中心相关,找到:获取我的折扣券接口,可以获得可用的优惠券,如需使用优惠券,则将couponId传入本接口,不使用,则留空或-1 POST /api/voucherMall/exchangeVoucherStock */
export async function exchangeVoucherStockUsingPOST(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.exchangeVoucherStockUsingPOSTParams,
  options?: { [key: string]: any },
) {
  return request<API.ResultDataBoolean_>('/api/voucherMall/exchangeVoucherStock', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** 商城商品分页 GET /api/voucherMall/getVoucherStockPage */
export async function getVoucherStockPageUsingGET(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getVoucherStockPageUsingGETParams,
  options?: { [key: string]: any },
) {
  return request<API.ResultDataPageInfoVoucherStockPageVo_>(
    '/api/voucherMall/getVoucherStockPage',
    {
      method: 'GET',
      params: {
