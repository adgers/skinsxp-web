...
/** 首页对战列表 GET /api/battle/getHostList */
export async function getHostListUsingGET(options?: { [key: string]: any }) {
  return request<API.ResultDataListBattleVo_>('/api/battle/getHostList', {
    method: 'GET',
    ...(options || {}),
  });
}
